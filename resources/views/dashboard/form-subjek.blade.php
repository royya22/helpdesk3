        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="panel panel-default address">
            <div class="panel-body">
              ...
              <hr>
              <form class="form-horizontal" id="input-form" action="{{ url('store-subjek') }}" method="post">
                {!! csrf_field() !!}
                <div class="form-group">
                  <label class="col-sm-3 control-label">Kode Subjek</label>
                  <div class="col-sm-9">
                    {{-- <h1 class="text-uppercase">{{ $kode_subjek }}</h1> --}}
                    <input type="text" class="form-control" name="kode_subjek" style="text-transform:uppercase" id="kode_subjek" class="span6" minlength="3" maxlength="3" autofocus/>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <textarea name="subjek" id="subjek" class="form-control" rows="3" style="resize: none;"></textarea>
