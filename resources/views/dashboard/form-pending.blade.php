                ...
                <div class="col-md-8">
                  {{-- <img src="https://cdn-icons-png.flaticon.com/512/3572/3572055.png" class="status"> --}}
                    ...
                    <form class="form-horizontal" id="input-form" action="{{ url('store-pending',$data->id_laporan) }}" method="post">
                      {!! csrf_field() !!}
                      <p>
                        <label class="control-label">Keterangan Pending</label>
                        <div>
                        <textarea name="keterangan_pending" id="keterangan_pending" class="form-control" rows="3" style="resize: none;" autofocus></textarea>
                        @if ($errors->has('keterangan_pending'))
                          <span class="help-block">
                            <strong style="color: red">{{ $errors->first('keterangan_pending') }}</strong>
                          </span>
                        @endif
                        </div>
                      </p>
