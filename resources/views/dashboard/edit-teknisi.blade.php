        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="panel panel-default address">
            <div class="panel-body">
              ...
              <hr>
              <form class="form-horizontal" id="input-form" action="{{ url('update-teknisi',$data->id_teknisi) }}" method="post">
                {!! csrf_field() !!}
                <div class="form-group">
                  <label class="col-sm-3 control-label">Kode Teknisi</label>
                  <div class="col-sm-9">
                    <h1 class="text-uppercase">{{ $data->kode_teknisi }}</h1>
                    <input hidden type="text" name="kode_teknisi" id="kode_teknisi" class="span6" value="{{ $data->kode_teknisi }}"/>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $data->nama_teknisi }}" class="form-control" name="nama_teknisi" id="nama_teknisi" class="span6"/>
                ...
                <div class="form-group">
                  <label class="col-sm-3 control-label">Nama Teknisi</label>
                  <div class="col-sm-9">
                    <input type="text" value="{{ $data->user_teknisi }}" class="form-control" name="user_teknisi" style="text-transform:lowercase" id="user_teknisi" class="span6" minlength="3" maxlength="3"/>
