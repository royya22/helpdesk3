                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group form-group-lg">
                      ...
                      @endif
                      <br>
                      <textarea name="deskripsi" class="form-control" rows="3" oninput="this.value = this.value.replace(/href|<|>/gi , '' )" placeholder="Deskripsi Layanan / Keluhan / Gangguan">{{ old('deskripsi') }}</textarea>
